...
<section>
    <div class="row">
        <!-- perfil -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="profile/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="<?= $profile['IMAGE_PROFILE'] ?>" alt="<?= $profile['NAME_PERSON'] ?>"
    ...
    <div class="row">
        ...
        <!-- registrar usuarios -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="user/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_user_insert.jpg" alt="Ususarios" title="Insertar usuarios"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
    ...
    <div class="row">
        <!-- lista usuarios -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="profile/list/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_users.jpg" alt="Usuarios" title="Ver usuarios registrados"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
        ...
        <!-- check in -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="checkIn/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_check-in.jpg" alt="Check-in" title="Registrar ingreso de clientes"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
                        <b>Check in</b>
                    </p>
        ...
        <!-- check consum -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="consume/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_consume.png" alt="Consumo" title="Registrar consumo de servicios del hotel"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
                        <b>Consumo</b>
                    </p>
    ...
    <div class="row">
        <!-- list room -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="room/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_room.jpg" alt="Habitaciones" title="Lista de habitaciones"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
        ...
        <!-- room calendar -->
        <div class="col-xs-12 col-sm-6 col-sm-3 col-lg-3">
            <a href="room/calendar/" class="app-underline">
                <div class="thumbnail alert">
                    <img src="img/system/ic_room_occupied.jpg" alt="Habitaciones ocupadas"
                         title="Ocupacion de habitaciones segun registros"
                         class="img-circle app-profile-user eldiv shrink">
                    <p class="text-center text-info">
                        <b>Habitaciones ocupadas</b>
                    </p>
                </div>
            </a>
        </div>
