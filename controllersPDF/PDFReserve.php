...
class PDFReserve extends FPDF {
	...
	private function cabeceraPrint() {
		...
		$this->Cell(190, 10, "Reserva", 0, 2, "C");
	...
	private function consumeFoodPrint($y, $precio_subtotal) {
		foreach ($this->listConsumeFood as $consumeFood) {
			...
			$this->SetXY(5, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeFood['UNIT_COST_FOOD'], 0, 1, 'C');
			$this->SetXY(30, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeFood['DATE_CONSUME_FOOD'], 0, 1, 'C');
			$this->SetXY(90, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, utf8_decode($consumeFood['NAME_FOOD']), 0, 1, 'C');
			$this->SetXY(115, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeFood['PRICE_CONSUME_FOOD'] . " " . $consumeFood['NAME_TYPE_MONEY'], 0, 1, 'C');
			$this->SetXY(150, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeFood['PAY_CONSUME_FOOD'] . " " . $consumeFood['NAME_TYPE_MONEY'], 0, 1, 'C');
	...
	private function consumeServicePrint($y, $precio_subtotal) {
		foreach ($this->listConsumeService as $consumeService) {
			$this->SetFont('Arial', '', 8);
			$this->SetXY(5, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['UNIT_CONSUME_SERVICE'], 0, 1, 'C');
			$this->SetXY(30, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['DATE_START_CONSUME_SERVICE'], 0, 1, 'C');
			$this->SetXY(60, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['DATE_END_CONSUME_SERVICE'], 0, 1, 'C');
			$this->SetXY(90, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['NAME_SERVICE'], 0, 1, 'C');
			$this->SetXY(115, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['PRICE_CONSUME_SERVICE'] . " " . $consumeService['NAME_TYPE_MONEY'], 0, 1, 'C');
			$this->SetXY(150, $y);
			$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, $consumeService['PAY_CONSUME_SERVICE'] . " " . $consumeService['NAME_TYPE_MONEY'], 0, 1, 'C');
			//Cálculo del subtotal
	...
	private function tableHeader() {
		...
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'UNIDADES', 0, 1, 'C');
		$this->SetXY(30, $top_productos);
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'FECHA INICIO', 0, 1, 'C');
		$this->SetXY(60, $top_productos);
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'FECHA FIN', 0, 1, 'C');
		$this->SetXY(90, $top_productos);
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'PRODUCTOS', 0, 1, 'C');
		$this->SetXY(115, $top_productos);
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'PRECIO', 0, 1, 'C');
		$this->SetXY(150, $top_productos);
		$this->Cell(PDFReserve::$WITH_TEXT, PDFReserve::$HEIGHT_TEXT, 'PAGADO', 0, 1, 'C');
